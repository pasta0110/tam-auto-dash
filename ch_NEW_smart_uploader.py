...
def download_erp_csv():
    ...
    try:
        ...
        resp = session.post(
            "http://ene.kins.co.kr/loginCheck.do",
            data=login_data
        )
        ...
        delivery_p = {
            ...
            "sord": "asc",
            "_search": "false",
            "colNames[]": ["매출처", "주문유형", "주문상태", "배송유형", "배송상태", "주문등록일", "해피콜", "해피콜시간", "배송예정일", "배송예정시간", "도착시간", "완료시간", "배송사", "배송담당", "상담메시지", "배송완료메모", "주문번호", "상품명", "수취인", "주소", "휴대전화", "전화", "판매인메모", "주문확정메모", "배송자메모", "상품코드", "수량", "옵션", "우편번호", "배송담당자 전화", "바코드번호", "제조일자", "검사자", "배송기사ID", "수정"],
            "dbColNames[]": ["sales_comp_nm", "order_type_nm", "order_stat_nm", "delivery_order_nm", "delivery_stat_nm", "order_reg_dt", "happy_call", "happy_call_dt", "delivery_dt", "delivery_dt_time", "arrived_time", "complete_dt", "delivery_comp_nm", "delivery_user_nm", "send_msg", "delivery_complete_msg", "order_no", "product_nm", "customer_nm", "customer_order_address", "customer_hp", "customer_phone", "delivery_msg", "ins_send_msg", "delivery_memo", "product_cd", "cnt", "order_option", "post_no", "delivery_user_hp", "barcode_no", "manufacturing_date", "inspector", "delivery_user_id", ""]
        }
        ...
        order_p = {
            ...
            "sord": "asc",
            "_search": "false",
            "colNames[]": ["매출처", "주문유형", "배송유형", "주문번호", "주문상태", "해피콜", "상품코드", "상품명", "판매인메모", "수취인", "수취인연락처", "상담메시지", "등록일", "배송예정일", "담당자", "배송사", "판매인", "판매인연락처", "우편번호", "주소", "판매지국", "판매지국 연락처", "문서번호", "제품구분", "접수유형", "판정", "조치결과", "수정"],
            "dbColNames[]": ["comp_nm", "order_type_nm", "delivery_order_type_nm", "order_no", "order_stat_nm", "happy_call", "product_cd", "product_nm", "delivery_msg", "customer_nm", "customer_hp", "send_msg", "reg_dt", "delivery_schedule_dt", "happycall_user_nm", "delivery_comp_nm", "order_nm", "order_hp", "post_no", "customer_order_address", "sale_branch", "sale_branch_phone", "doc_no", "classCd", "rcptType", "asStat", "asResult", ""]
        }
